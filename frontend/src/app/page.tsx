      ...
      <div className="flex flex-col items-center h-screen">
        ...
        <div className="flex flex-row">
          ...
          <div className="absolute bg-main-red w-12 h-32 rounded-e-xl left-0 bottom-36
                          sm:w-16 sm:h-40 sm:bottom-44"></div>
        ...
        <h1 className="text-main-blue text-2xl text-center w-[50%] mt-16 mb-44 z-1
                      sm:mt-56 sm:text-4xl" >Start your learning journey today!</h1>
        ...
        <Link href="/signin"><button className="bg-main-red text-main-white text-lg rounded-lg h-12 w-40 my-4
